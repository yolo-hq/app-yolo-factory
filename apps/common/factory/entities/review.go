...
type Review struct {
	...
	AntiPatterns    string  `json:"anti_patterns" bun:"anti_patterns,default:'[]'" fake:"-"`
	CriteriaResults string  `json:"criteria_results" bun:"criteria_results,notnull" fake:"sentence:15"`
	Suggestions     string  `json:"suggestions" bun:"suggestions,default:'[]'" fake:"-"`
	CostUSD         float64 `json:"cost_usd" bun:"cost_usd,default:0" fake:"float:0,5"`
